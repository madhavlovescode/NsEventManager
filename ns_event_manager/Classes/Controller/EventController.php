...
class EventController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
    ...
    {
     //\TYPO3\CMS\Extbase\Utility\DebuggerUtility::var_dump($event, __FILE__.' Line No. '.__LINE__);die();
    ...
    public function updateAction(\NITSAN\NsEventManager\Domain\Model\Event $event)
    {
         ...
         if($_FILES['tx_nseventmanager_nseventcrud']['tmp_name']['image']){
            ...
            if ($fileData) {
                ...
                $fileRepository = GeneralUtility::makeInstance(FileRepository::class);
    //\TYPO3\CMS\Extbase\Utility\DebuggerUtility::var_dump($fileRepository, __FILE__.' Line No. '.__LINE__);die();
                $fileObjects = $fileRepository->findByRelation(
                    'tx_nseventmanager_domain_model_event',
                    'image',
                    $event->getUid()
